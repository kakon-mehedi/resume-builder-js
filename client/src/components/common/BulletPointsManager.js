        ...
        <div className="flex items-start gap-2">
          ...
          <div className="text-sm text-blue-700">
            ...
            <ul className="list-disc list-inside space-y-0.5 text-xs">
              <li>Start with action verbs (Led, Built, Implemented, Optimized)</li>
              <li>Include quantifiable results (increased by 40%, managed team of 5)</li>
              <li>Focus on achievements, not just responsibilities</li>
              <li>Use specific technologies and metrics when possible</li>
            </ul>
          </div>
        </div>
      </div>
